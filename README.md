...
Same as [Validate Shell Snippets](#validate-shell-snippets) but using the pre-built docker image from the release (tag v3.0.0)
...
using the pre-built docker image from the release (tag v3.0.0)
